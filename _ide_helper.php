...
namespace NextApps\VerificationCode {
     ...
     */        class VerificationCode {
         ...
         *
         * @static 
         */        public static function send($verifiable, $channel = 'mail')
        {
                        /** @var \NextApps\VerificationCode\VerificationCodeManager $instance */
                        return $instance->send($verifiable, $channel);
        }
                    /**
         * 
         *
         * @static 
         */        public static function verify($code, $verifiable, $deleteAfterVerification = true)
        {
                        /** @var \NextApps\VerificationCode\VerificationCodeManager $instance */
                        return $instance->verify($code, $verifiable, $deleteAfterVerification);
        }
                    /**
         * 
         *
...
namespace  {
            ...
            class VerificationCode extends \NextApps\VerificationCode\VerificationCode {}
    }
